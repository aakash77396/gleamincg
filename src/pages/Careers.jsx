    ...
    <section className="min-h-screen bg-[#0D0D0D] text-white px-6 md:px-16 py-20">
      ...
      <div className="max-w-5xl mx-auto text-center mb-16">
        ...
        <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6">
          Build Beautiful
          <br />
          <span className="text-[#C9A35D]">Spaces With Us</span>
        </h1>

        <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
          We are always looking for creative minds, passionate designers,
          and talented professionals who want to create exceptional interiors.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-4">
          {jobs.map((job, index) => (
            <div
              key={index}
              className="group border border-[#2A2A2A] bg-[#171717] rounded-xl p-6 md:p-8
              hover:border-[#C9A35D] transition-all duration-300"
            >
      ...
      <div className="max-w-4xl mx-auto mt-20 text-center border-t border-[#2A2A2A] pt-12">
        ...
        <p className="text-gray-400 text-lg leading-relaxed">
          To apply for any of the above positions, please send your
          resume and portfolio to
        </p>

        <a
          href="mailto:your-email@example.com"
          className="inline-block mt-5 text-[#C9A35D] text-xl font-medium
          hover:underline"
        >
